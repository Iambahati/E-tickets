...
$attendees_data = $interfaces->getEventAttendees($eventId);
        ...
        <div class="orders">
          ...
          <?php if ($attendees_data) : ?>
            <table class="events-table">
              ...
              <tbody>
                <?php foreach ($attendees_data as $attendee) : ?>
                  <tr>
                    <td><?= $attendee['first_name'] . ' ' . $attendee['last_name'] ?></td>
                    <td><?= $attendee['email'] ?></td>
                    <td><?= $attendee['tickets_bought'] ?></td>
                    <td>
                      <a href="mailto:<?= $attendee['email'] ?>" style="display: flex; align-items: center; gap: 5px; color: #388e3c;">
          ...
          <?php else : ?>
            <h3 style="margin-left: 20%;">No attendees found for this event!</h3>
          <?php endif; ?>
        </div>
