...
CREATE TABLE `users` (
  ...
  `first_name` varchar(50) DEFAULT NULL,  -- Nullable first name
  `last_name` varchar(50) DEFAULT NULL,   -- Nullable last name
  `email` varchar(50) NOT NULL,
  `contact` varchar(10) NOT NULL,
  `password` varchar(255) NOT NULL,
  `organization_name` varchar(100) DEFAULT NULL,  -- Nullable organization name
  `role` enum('1', '2', '3') NOT NULL DEFAULT '3', -- 1 = admin, 2 = organizer, 3 = buyer
  PRIMARY KEY (`id`)
